...
// Todo array ou objeto deve ter o tipo da variavel informado manualmente (TypeScript)
interface Item {
    id: number;
    title: string;
    image_url: string;
...
const CreatePoint = () => {
    ...
    const [selectedUCity, setSelecteCity] = useState('0');
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            ...
                            <select name="city" id="city" value={ selectedUCity } onChange={ handleSelectCity }>
